...
#_Bmark_years: beg_bio, end_bio, beg_selex, end_selex, beg_relF, end_relF (enter actual year, or values of 0 or -integer to be rel. endyr)
 -3 -1 -3 -1 -3 -1
#  2004 2006 2004 2006 2004 2006 # after processing
...
-3 -1 -3 -1
#  2002 2004 2002 2004 # after processing
...
2200  #FirstYear for caps and allocations (should be after years with fixed inputs)
...
#_Fleet:  F1JLL F2SPelPS F3TunaPS F4JpnTroll F5JpnPL F6JpnSetNet F7TWLL F8EPOPS F9EPOSP F10others
#  0.000759252 0.0747243 0.0225395 0.00431528 0.00800841 0.0121629 0.00280846 0.159845 0.0137521 0
#  0.00161952 0.188678 0.000491136 0.0521481 0.00200567 0.00582924 0 0.00285173 0.000586843 0.00385033
#  0.000717745 0.0269065 0 0.0316843 0.00271954 0.00304599 0 0 0 0
#  0.02365 0.133961 0.00691542 0.0367436 0.00703601 0.0201607 0.068732 0.080127 0.000624358 0
...
# allocation fraction for each of: 1 allocation groups
 1
5  # Number of forecast catch levels to input (else calc catch from forecast F)
