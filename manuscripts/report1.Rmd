...
A case study using guidelines specifc to the observation error model will be presented including best practice princeiples learned from the items 1-4 above.
