...
dirVpa=file.path(dirDat,"inputs/vpa")
...
waa=read.table(file.path(dirVpa,"ebft/bfte2017.d1"),skip=428,nrows=483-428)
...
paa=read.table(file.path(dirVpa,"ebft/bfte2017.d1"),skip=262,nrows=415-262)
names(paa)[1:2]=c("name","year")
paa=melt(paa,id=c("name","year"))
...
```{r cca}
caa=read.table(file.path(dirVpa,"ebft/bfte2017.d1"),skip=24,nrows=71-24)
names(caa)[1]="year"
