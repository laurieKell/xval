...
dirTex="/home/laurie/Desktop/SCRS/workshops/vpa/sessions/tex"
dirDat="/home/laurie/Desktop/SCRS/workshops/vpa/sessions/data"
dirAnl="/home/laurie/ownCloud/GVYP_VPA/BFTAss/Analysis"
dirStt="/home/laurie/ownCloud/GVYP_VPA/BFTAss/Statistics"

source('~/Desktop/flr/FLife/R/refs.R')

ctl=c("vpa/east/reported/med/bfte2014.c1",
      "vpa/east/inflated/med/bfte2014.c1")

file=file.path(dirAnl,ctl)
...
dgs=mdply(data.frame(scen=c("/home/laurie/Desktop/kobe/inputs/bfte/2014/vpa/reported/med/MINUS0.R",
                            "/home/laurie/Desktop/kobe/inputs/bfte/2014/vpa/inflated/med/MINUS0.R"),
                     stringsAsFactors=FALSE),
                     function(scen) diagsVpa2box(scen))
dgs=transform(dgs,Scenario=factor(scen,labels=c("Reported","Inflated")))
load(file.path(dirDat,"jk.RData"))

rfDat=ldply(jk, function(x) model.frame(refs(x[[1]][[2]], s=0.9)))
rfDat=cbind(dgs,rfDat)
save(rfDat,file="/home/laurie/Desktop/tmp/rfDat.RData",compress="xz")
```
